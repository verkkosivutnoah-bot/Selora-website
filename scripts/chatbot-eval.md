...
26 questions a real visitor might ask the widget, in Finnish and English.
...
| 3 | FI: *Mitkä ovat kolme pakettia ja paljonko ne maksavat?* | Perussivu 298 €, Täysi sivusto 498 €, Elämyssivusto 898 €, kaikki kertamaksuja. Lisäksi ylläpito ja hosting 20 €/kk. | ✅ pricing-card extraction names the package once per card: `Perussivu (298 €, kertamaksu) — ...` etc. |
...
| 14 | EN: *What happens after the site launches — is there ongoing support?* | The site is yours. Maintenance and hosting are 20 €/month and cover updates, backups and design changes; you can also run the site yourself, and there's no long contract. | ✅ index.html FAQ + hinnoittelu.html "Ylläpito 20 € kuukaudessa" |
| 15 | FI: *Onko hinnassa piilokuluja, ja milloin maksan?* | Ei piilokuluja — sovittu hinta kattaa suunnittelun, rakennuksen ja julkaisun, ja lisätoiveista sovitaan aina hinta etukäteen. Maksat vasta kun sivusto on julkaistu, et mitään etukäteen. Hyväksytyt maksutavat: kortti, lasku ja verkkopankki. | ✅ hinnoittelu.html FAQ + "Maksat kerran" section |
...
| 17 | FI: *Mitä 20 euron kuukausiylläpito sisältää?* | Hosting ja verkkotunnuksen hallinta, design-muutokset ja sisältöpäivitykset, tietoturva- ja ohjelmistopäivitykset, varmuuskopiot ja palautus, käyttökatkojen seuranta sekä tuki sähköpostitse. Sama hinta kaikille paketeille, irtisanottavissa milloin tahansa. | ✅ the `.upkeep` card is extracted as one attributed statement, so the features stay tied to the 20 €/kk price |
| 18 | FI: *Voinko nähdä esimerkkejä aiemmista sivustoista?* | Kyllä, verkkosivusuunnittelu.html-sivulla on esimerkkiprojekteja (Vantage, Plume, Nocturne, The Green Electrician) — huom. sisältö toteaa nämä ovat esimerkkiprojekteja eivätkä oikeita asiakasprojekteja, se kannattaa mainita vastauksessa. | ✅ verkkosivusuunnittelu.html "Esimerkkitöitä" |

## Questions the chatbot must refuse or deflect

The knowledge base contains **nothing** about these — the correct behaviour
is "I don't know, here's the contact page," never an invented answer. The
one exception is R4, which is a correct-the-premise case rather than a
refusal: the service exists, but not at the price the question assumes.
...
| R4 | EN: *Do you offer web hosting for 5 euros a month?* | **Correct-the-premise, not refuse.** Hosting *is* offered, bundled into maintenance at 20 €/month — but 5 €/month is not a price the site states. The bot must give the real 20 € figure and must not agree to 5 €. | ✅ 20 €/kk maintenance is in the knowledge base; no 5 € tier exists anywhere |
