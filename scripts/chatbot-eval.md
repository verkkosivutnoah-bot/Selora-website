...
| 3 | FI: *Mitkä ovat kolme pakettia ja paljonko ne maksavat?* | Perussivu 298 €, Täysi sivusto 498 €, Elämyssivusto 898 €, kaikki kertamaksuja. Lisäksi ylläpito ja hosting 49 €/kk. | ✅ pricing-card extraction names the package once per card: `Perussivu (298 €, kertamaksu) — ...` etc. |
...
| 14 | EN: *What happens after the site launches — is there ongoing support?* | The site is yours. Maintenance and hosting are 49 €/month and cover updates, backups and design changes; you can also run the site yourself, and there's no long contract. | ✅ index.html FAQ + hinnoittelu.html "Ylläpito 49 € kuukaudessa" |
...
| 17 | FI: *Mitä 49 euron kuukausiylläpito sisältää?* | Hosting ja verkkotunnuksen hallinta, design-muutokset ja sisältöpäivitykset, tietoturva- ja ohjelmistopäivitykset, varmuuskopiot ja palautus, käyttökatkojen seuranta sekä tuki sähköpostitse. Sama hinta kaikille paketeille, irtisanottavissa milloin tahansa. | ✅ the `.upkeep` card is extracted as one attributed statement, so the features stay tied to the 49 €/kk price |
