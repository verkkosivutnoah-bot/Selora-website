...
(function () {
  ...
  const DICT = {
    ...
    'Suomenkielinen tekoälyvastaanottaja, joka vastaa puheluihin 24/7, varaa ajat kalenteriisi ja lähettää vahvistusviestit.':
      'Our Finnish-speaking AI receptionist answers calls 24/7, books appointments straight into your calendar, and sends confirmation messages.',
    ...
    'Hosting ja verkkotunnuksen hallinta': 'Hosting and domain management',
    'Design-muutokset ja sisältöpäivitykset': 'Design changes and content updates',
    'Milloin maksan?': 'When do I pay?',
    'Tietoturva- ja ohjelmistopäivitykset': 'Security and software updates',
    'Varmuuskopiot ja palautus': 'Backups and restore',
    'Käyttökatkojen seuranta': 'Uptime monitoring',
    'Tuki sähköpostitse': 'Support by email',
    'Sisältää hostingin, päivitykset ja design-muutokset. Irtisanottavissa milloin tahansa.':
      'Includes hosting, updates and design changes. Cancellable at any time.',
    'Maksat vasta julkaisun jälkeen': 'You pay after launch',
    'Et maksa mitään etukäteen. Lasku lähtee vasta kun sivusto on julkaistu ja olet hyväksynyt sen.':
    ...
    'Värit, typografia ja kuvamaailma valitaan yrityksesi mukaan. Ei valmiita teemoja eikä mallipohjia.': 'Colours, typography and imagery are chosen to match your business. No off-the-shelf themes or templates.',
    'Yli puolet kävijöistä saapuu puhelimella. Sivusto suunnitellaan ensin mobiilille ja testataan joka näytöllä.': 'Over half of visitors arrive on a phone. The site is designed mobile first and tested on every screen.',
    'Kävijä löytää etsimänsä muutamassa sekunnissa. Tärkein sisältö ja toimintakehotteet näkyvät ensimmäisenä.': 'Visitors find what they need in seconds. The most important content and calls to action show up first.',
    'Sivusto latautuu alle sekunnissa myös mobiiliverkossa. Kuvat, koodi ja fontit optimoidaan jo rakennusvaiheessa.': 'The site loads in under a second, even on mobile networks. Images, code and fonts are optimised during the build.',
    'Selkeät lomakkeet ohjaavat kävijän yhteydenottoon. Viestit tulevat suoraan sähköpostiisi, roskapostisuodatus mukana.': 'Clear forms guide visitors to get in touch. Messages land straight in your inbox, with spam filtering built in.',
    'Tekstit, kuvat ja hinnat on helppo päivittää ilman koodia. Käyttöönottokoulutus ja tuki sisältyvät.': 'Text, images and prices are easy to update without code. Onboarding training and support are included.',
    'Otsikkorakenne, metatiedot ja sivukartta ovat kunnossa heti julkaisusta alkaen.': 'Heading structure, metadata and a sitemap are in place from launch.',
    'Selvitämme millä hakusanoilla asiakkaasi etsivät palveluitasi ja rakennamme sisällön niiden ympärille.': 'We find out which search terms your customers use and build the content around them.',
    'Suomi ja englanti samalla sivustolla. Kävijä vaihtaa kieltä yhdellä klikkauksella, molemmat optimoidaan erikseen.': 'Finnish and English on the same site. Visitors switch language with one click, and both versions are optimised separately.',
    'Automaattiset viestit hoitavat yhteydenotot puolestasi. Kävijä saa vahvistuksen heti, sinä saat tiedon uudesta liidistä.': 'Automated messages handle enquiries for you. The visitor gets an instant confirmation, and you get notified of the new lead.',
    'Näet mistä kävijät tulevat ja kuinka moni ottaa yhteyttä. Ilman evästebannerin vaativaa seurantaa.': 'See where visitors come from and how many get in touch, with tracking that needs no cookie banner.',
    ...
    'Sivusto, joka tekee': 'A website that does',
    'työn puolestasi.': 'the work for you.',
    'Rakennamme sivuston alusta asti sinun yrityksellesi. Ei valmiita mallipohjia. Maksat kerran, ja sivusto on sinun.': 'We build your site from scratch for your business. No off-the-shelf templates. You pay once and the site is yours.',
    'Asiakkaat löytävät sinut': 'Customers find you',
    'Sivusto näkyy Googlessa silloin, kun joku etsii sinun palveluitasi omalta alueeltasi.': 'Your site shows up on Google when someone nearby searches for what you do.',
    'Sivusto aukeaa heti': 'Your site opens instantly',
    'Alle sekunnissa myös puhelimella. Kukaan ei ehdi turhautua ja poistua kilpailijalle.': 'Under a second, on mobile too. Nobody gets impatient and leaves for a competitor.',
    'Yhteydenotot tulevat sinulle': 'Enquiries come straight to you',
    'Selkeä lomake ohjaa asiakkaan ottamaan yhteyttä. Viesti tulee suoraan sähköpostiisi.': 'A clear form guides the customer to get in touch. The message lands straight in your inbox.',
    'Kävijätilastot': 'Visitor stats',
    'Evästeet kuntoon': 'Cookies handled',
    'Näkyy Googlessa': 'Found on Google',
    'Suomi ja englanti': 'Finnish and English',
    'Ohjeet ylläpitoon': 'Upkeep instructions',
    'Valitse se, joka sopii yrityksesi kokoon. Kerromme kartoituspuhelussa kumpi kannattaa.': 'Pick the one that fits the size of your business. On the intro call we tell you which is worth it.',
    'Kokonainen sivusto': 'A full website',
    'Etusivu, palvelut, tietoa meistä ja yhteystiedot. Kertoo yrityksesi tarinan ja rakentaa luottamusta.': 'Home, services, about and contact. Tells your story and builds trust.',
    'Yksi selkeä sivu, jolla kerrot mitä teet ja miten sinuun saa yhteyden. Nopein tapa päästä verkkoon.': 'One clear page telling people what you do and how to reach you. The fastest way to get online.',
    'Sivusto, jossa on juuri sinun alasi tarpeet: ruokalista, ajanvaraus, hinnasto tai galleria.': 'A site built around your trade: a menu, bookings, a price list or a gallery.',
    'Sopii: uusi yritys, yksi palvelu': 'Good for: a new business, one service',
    'Sopii: vakiintunut yritys': 'Good for: an established business',
    'Näin se etenee': 'How it goes',
    'ei enempää.': 'no more.',
    ...
    'Sivusto aukeaa': 'Your site goes live',
    'Julkaisemme sivuston ja hoidamme tekniikan. Sinun ei tarvitse osata koodata mitään.': 'We publish the site and handle the technical side. You never have to touch any code.',
    'Sitten se on valmis': 'And then it is done',
    ...
    'Kirjoita meille milloin vain.': 'Write to us any time.',
    'Arkisin klo 9–17.': 'Weekdays 9am–5pm.',
    'Arkipäivisin, ihmiseltä ihmiselle.': 'On weekdays, from a person, not a bot.',
    'Palvelemme koko Suomessa.': 'We serve the whole of Finland.',
    ...
    'Kolme pakettia.': 'Three packages.',
    'Elämyssivusto': 'Showcase site',
    'Näyttävin': 'Most striking',
    'Brändeille, jotka haluavat sivuston jonka muistaa. Kerronnallinen, liikkuva ja silti nopea.': 'For brands that want a site people remember. Narrative, animated and still fast.',
    'Kaikki mitä Täysi sivusto sisältää': 'Everything in the Full site',
    'Kerronnallinen vieritys ja parallax-syvyys': 'Narrative scrolling and parallax depth',
    'Näyttävät liikkeet ja taustagrafiikat': 'Striking motion and background visuals',
    'Kuvitus ja visuaalinen suunta omalle brändillesi': 'Illustration and art direction for your brand',
    'Suorituskykybudjetti: näyttävyys ei hidasta sivustoa': 'A performance budget, so the visuals never slow the site down',
    'Toimii myös kevennettynä, jos kävijä on rajoittanut liikettä': 'Falls back to a calm version if the visitor has reduced motion on',
    'Katso esimerkki →': 'See an example →',
    'Visuaalinen kerronta': 'Visual storytelling',
    'Kerronnallinen vieritys ja parallax': 'Narrative scrolling and parallax',
    'Kuvitus ja visuaalinen suunta': 'Illustration and art direction',
    'Kevyet': 'Light',
    'Suorituskykybudjetti': 'Performance budget',
    'Kuinka näyttävä sivuston pitää olla?': 'How striking does the site need to be?',
    'Selkeä ja asiallinen riittää': 'Clear and businesslike is enough',
    'Haluan sivuston joka jää mieleen': 'I want a site people remember',
    'Katso Elämyssivusto ↓': 'See the Showcase site ↓',
    ...
    'Tarjous, -33 %': 'Sale, -33%',
    'Puhutaan': 'Let us talk for',
    'Käymme läpi tilanteesi ja kerromme suoraan, kannattaako edetä. Maksuton eikä sido mihinkään.': 'We go through your situation and tell you straight whether it is worth going ahead. Free and no commitment.',
    'Kerrot mitä olet suunnittelemassa': 'You tell us what you are planning',
    'Ei tarvitse olla valmista suunnitelmaa. Riittää että tiedät mitä yrityksesi tekee.': 'You do not need a finished plan. Knowing what your business does is enough.',
    'Katsomme mitä sivusto tarvitsee': 'We work out what the site needs',
    'Sivumäärä, sisällöt ja aikataulu. Kerromme myös jos et mielestämme tarvitse uutta sivustoa.': 'Page count, content and schedule. We will also say so if we think you do not need a new site.',
    'Saat hinnan ja aikataulun': 'You get a price and a schedule',
    'Kiinteä hinta kirjallisena puhelun jälkeen. Ei tarjouskikkailua.': 'A fixed price in writing after the call. No quote games.',
    'Maksuton ja sitoumukseton': 'Free and without commitment',
    'Puhut suoraan tekijän kanssa, ei myyjän': 'You speak to the person who builds it, not a salesperson',
    'Eikö kalenterista löydy sopivaa aikaa?': 'Nothing in the calendar suits you?',
    'Kirjoita meille': 'Write to us',
    'niin ehdotamme aikaa.': 'and we will suggest a time.',
    'Vapaat ajat reaaliajassa': 'Free slots in real time',
    'Tai kirjoita,': 'Or write,',
    'niin vastaamme.': 'and we will reply.',
    'Kerro lyhyesti mitä tarvitset. Vastaamme neljän tunnin sisällä arkipäivisin.': 'Tell us briefly what you need. We reply within four hours on weekdays.',
    'Muut kanavat': 'Other channels',
    'Tai tavoita meidät': 'Or reach us',
    'suoraan.': 'directly.',
    ...
    'Esimerkkityöt': 'Examples',
    'Katso mitä olemme': 'See what we have',
    'rakentaneet.': 'built.',
    'Yhdeksän esimerkkisivustoa, jotka voit avata ja kokeilla itse.': 'Nine example sites you can open and try yourself.',
    'Yhdeksän sivustoa,': 'Nine sites,',
    'yksi tapa tehdä.': 'one way of working.',
    'Jokainen näistä on rakennettu alusta asti. Suodata toimialan mukaan ja avaa mikä tahansa, ne ovat oikeita sivustoja eivätkä kuvia.': 'Every one of these was built from scratch. Filter by industry and open any of them, they are real sites and not pictures.',
    'Suodata toimialan mukaan': 'Filter by industry',
    'Järjestys': 'Sort',
    'Uusimmat ensin': 'Newest first',
    'Nimi A, Ö': 'Name A to Z',
    'Ei osumia tällä suodattimella.': 'No matches for this filter.',
    'Haluatko oman sivuston tälle listalle?': 'Want your own site on this list?',
    'Takaisin verkkosivusuunnitteluun': 'Back to web design',
    'Katso kaikki esimerkit →': 'See all examples →',
    'Kiinteistönvälitys · Luksusasunnot': 'Real estate · Luxury homes',
    'Eläinklinikka · Ajanvaraus': 'Animal clinic · Booking',
